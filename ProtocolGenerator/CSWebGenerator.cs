...
{
    public class CSWebGenerator : ProtocolGenerator
    {
        public CSWebGenerator(DataSet dataSet) : base(dataSet)
        {
        ...
        protected override String GetEndingForSource()
        {
            ...
            return
                strEnum +
                "\n\n\tprivate delegate String mStrDelegate(" + mBufferClassName + " buffer);" +
                ...
                case PROTOCOL_FUNCTION_TYPE.PARSER:
                    {
                        ...
                        return "\tpublic String pp" + funcName + "(";
                    }
                case PROTOCOL_FUNCTION_TYPE.SEND:
                    {
                        String strReturnType = "";
                        if (funcName.Contains("Ack"))
                        {
                        ...
                        return "\tpublic " + strReturnType + " sf" + funcName + "(";
                    }
                // recv 함수는 recv 후 구현 내용이 들어가야 하므로 순수가상함수로 반드시 재구현 하도록 하자.
                case PROTOCOL_FUNCTION_TYPE.RECV:
                    return "\tpublic abstract String rf" + funcName + "(";
                default:
                    return "";
            }
        }
                ...
                case PROTOCOL_FUNCTION_TYPE.SEND:
                    {
                        ...
                        String strReturn = "";
                        // 반환 코드가 C#에서는 ack 인 경우 문자열을 리턴해주도록 하자
                        if (funcName.Contains("Ack"))
                        {
